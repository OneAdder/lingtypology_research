...
\begin{samepage}
  ...
  \item colour. A library for colours.
\end{samepage}
\end{itemize}
...
\begin{itemize}
 ...
 By default, if you add stroke features, a legend will appear. To shut it down set \textit{stroke\_legend} attribute to \textit{False}.
